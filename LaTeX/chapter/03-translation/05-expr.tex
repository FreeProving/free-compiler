...
\begin{minted}{haskell}
  ...
  undefined = Nothing
\end{minted}
For the translation of \haskell{undefined}, we now just need to model the \haskell{Maybe} monad using the free monad, i.e. instatiate $Shape$ and $Pos$ appropriately.
...
For the \coq{Identity} monad, on the other hand, no \coq{Partial} can be specified.
