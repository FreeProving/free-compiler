...
testTypeInferencePass = describe "FreeC.Analysis.TypeInference"
  $ do
    context "error terms"
      $ do
        ...
        it "infers the type of the error term 'error \"...\"' correctly"
          ...
          $ do
            shouldInferType (NonRecursive "f = error \"...\"")
              ["f @a :: a = error @a \"...\""]
    context "constructors and literals"
      $ do
        ...
        it "infers the type of integer literals correctly"
          ...
          $ do
            _ <- defineTestTypeCon "Prelude.Integer" 0 []
            shouldInferType (NonRecursive "f = 42")
              ["f :: Prelude.Integer = 42"]
    context "function applications"
      $ do
        it "infers the type of predefined operations correctly"
          ...
          $ do
            ...
            shouldInferType (NonRecursive "f = foo")
              ["f :: Bar -> Bar -> Foo = foo"]
        it
          "infers the type of partially applied predefined operations correctly"
          $ shouldSucceedWith
          $ do
            _ <- defineTestTypeCon "Foo" 0 []
            _ <- defineTestTypeCon "Bar" 0 []
    ...
    context "expression type signatures"
      $ do
        ...
        context "non-recursive functions"
          $ do
    ...
    context "functions type signatures"
      $ do
        ...
        it "allows return type annotation to make type more specific"
          ...
          $ do
            ...
            shouldInferType (NonRecursive "fooId x :: Foo = x")
              ["fooId (x :: Foo) :: Foo = x"]
    context "rigid type variables"
      $ do
        it "cannot match rigid type variable with type constructor"
          $ do
        ...
        it "cannot match type constructor with rigid type variable"
          $ do
            ...
            shouldFailPretty
              $ do
                ...
                typeInferencePass (NonRecursive funcDecl)
        it "cannot match two rigid type variables"
          $ do
