...
\begin{align*}
  ...
  \toCoq{e_2} &: \toCoq{\tau_1}
\end{align*}
If we had a value $f$ of type $\toCoq{\tau_1} \rightarrow \toCoq{\tau_2}$, we could apply $f$ to $\toCoq{e_2}$ to obtain a value of type $\toCoq{\tau_2}$ which would satisfy the invariant.
