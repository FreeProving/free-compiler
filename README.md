...
To load module dependencies from the base library, i.e. module interface files, the compiler uses the same mechanism that is used to load module dependencies.
