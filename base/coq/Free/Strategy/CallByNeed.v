...
From Base Require Import Free.Strategy.CallByName.
...
(* If a computation is never used twice, no sharing semantics are equivalent
   to call-by-name semantics. *)
Notation "'callByNeed'" := callByName.
