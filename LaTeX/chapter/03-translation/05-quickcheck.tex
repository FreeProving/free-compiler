...
The \haskell{(===)} and \haskell{(=/=)} operations usually require an instance of the type \haskell{Eq} type class.
Since users cannot implement \haskell{Eq} instances in our compiler, we allow these two operators to be used with any type and use structural equality for the actual comparison.
