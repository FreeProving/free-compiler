...
-- Case expressions with a single variable pattern are sometimes generated by
-- the pattern matching compiler. They are translated to a lambda abstraction
-- that is immediately applied to the scrutinee.
