...
Class Handler (Shape : Type) (Pos : Shape -> Type) := {
  ...
  handledType : forall {A : Type} {NF : Normalform Shape Pos A}, Type;
  ...
  handle : forall {A : Type} {NF : Normalform Shape Pos A}, Free Shape Pos A -> handledType;
  (* TODO *)
  handleProp : Free Shape Pos Prop -> Prop
}.
