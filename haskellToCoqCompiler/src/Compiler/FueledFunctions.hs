...
addFuelArgToRecursiveCall (G.If style cond depRet thenTerm elseTerm) fTerm funName =
  G.If
    ...
    cond
    depRet
    (addFuelArgToRecursiveCall thenTerm fTerm funName)
    (addFuelArgToRecursiveCall elseTerm fTerm funName)
...
convertFueledTerm (G.If style cond depRet thenTerm elseTerm) funBinders funName typeSigs recursiveFuns =
  G.If
    ...
    cond
    depRet
    (convertFueledTerm thenTerm funBinders funName typeSigs recursiveFuns)
    (convertFueledTerm elseTerm funBinders funName typeSigs recursiveFuns)
