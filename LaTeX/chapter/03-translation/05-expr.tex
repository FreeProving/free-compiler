...
The bind operation corresponds to the fact that Haskell evaluates the condition before selecting the \haskell{then} or \haskell{else} branch.
...
As mentioned in \autoref{sec:translation:assumptions} already, list and pair literals are just \textit{syntactic sugar} for the application of their constructors.
