...
As discussed in \autoref{sec:translation:func-decl:partial}, partial functions can be identified by adding two additional nodes to the dependency graph for \haskell{undefined} and \haskell{error}.
