...
testKindCheckPass = describe "FreeC.Pass.KindCheckPassTests"
  $ do
    testValidTypes
    testNotValidTypes
...
testValidTypes :: Spec
testValidTypes = context "valid types"
  $ do
    it "should accept a single type variable"
      $ do
        ...
        shouldSucceed
          $ do
            ...
            checkType input
    it "should accept constant type constructors"
      $ do
        ...
        shouldSucceed
          $ do
            ...
            checkType input
    it "should accept constant type synonyms"
      $ do
        ...
        shouldSucceed
          $ do
            ...
            checkType input
    it "should accept fully applied type constructors"
      $ do
        ...
        shouldSucceed
          $ do
            ...
            checkType input
    it "should accept fully applied type synonyms"
      $ do
        input <- expectParseTestType "State Int Int"
        shouldSucceed
          $ do
            ...
            checkType input
    it "should accept a single type variable in function type signatures"
      $ do
        ...
        shouldSucceed
          $ do
            ...
            kindCheckPass input
    it "should accept a single type variable in function return types"
      $ do
      ...
      $ do
        ...
        shouldSucceed
          $ do
            ...
            _ <- defineTestFunc "f" 1 "forall a. a -> a"
            kindCheckPass input
    it "should accept a single type variable in type annotated variables"
      $ do
...
testNotValidTypes = context "not valid types"
  $ do
    it "should not accept type variable applications"
      $ do
        ...
        shouldFail
          $ do
            ...
            _ <- defineTestTypeVar "a"
            checkType input
    it "should not accept overapplied function application"
      $ do
        ...
        shouldFail
          $ do
            ...
            checkType input
    it "should not accept underapplied type constructors"
      $ do
        ...
        shouldFail
          $ do
            ...
            _ <- defineTestTypeCon "Int" 0 []
            checkType input
    it "should not accept underapplied type synonyms"
      $ do
        input <- expectParseTestType "State Int"
        shouldFail
          $ do
            ...
            _ <- defineTestTypeCon "(,)" 2 []
            checkType input
    it "should not accept overapplied type constructors"
      $ do
        ...
        shouldFail
          $ do
            ...
            _ <- defineTestTypeCon "Int" 0 []
            checkType input
    it "should not accept overapplied type synonyms"
      $ do
        input <- expectParseTestType "State Int Int Int"
        shouldFail
          $ do
            ...
            checkType input
    it
      "should not accept type variable applications in function type signatures"
      $ do
        input <- expectParseTestModule
      ...
      $ do
        ...
        shouldFail
          $ do
            ...
            kindCheckPass input
    it
      "should not accept type variable applications in type annotated variables"
      $ do
