...
For simplicity we will first consider only independent declarations and extend the resulting translation rules to support mutually dependendent declarations at the end of this section.
...
Similarily we can use a \coq{Definition}-sentence to to assign a name to a term in Coq.
...
\end{align*}
We assume without a proof that this property translates to the extensions of $\sigma$ and $\sigma'$.
