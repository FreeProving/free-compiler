module Compiler.Backend.Coq.Converter.QuickCheckTests where
...
testConvertQuickCheckProperty =
  describe "Compiler.Backend.Coq.Converter.QuickCheck.convertQuickCheckProperty"
    $ do
        ...
        it "translates implications correctly"
          $ shouldSucceed
          $ fromConverter
          $ do
              importQuickCheck
