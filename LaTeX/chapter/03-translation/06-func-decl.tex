...
\begin{enumerate}
  ...
  \item
  Translate all helper functions to a single joined \coq{Fixpoint} sentence.
  Just like with \coq{Inductive} sentences, \coq{Fixpoint} sentences can be concatenated using the \coq{with} keyword.
  \item
...
\paragraph{Splitting into Helper and Main Function}
